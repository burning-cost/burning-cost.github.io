...
<div class="lib-entry">
  ...
  <p class="lib-entry-problem">Your pricing actuary says postcode is a legitimate risk variable, but the compliance team is worried it correlates with ethnicity — and under FCA EP25/2 you need to quantify the indirect discrimination risk, not just assert there is none.</p>
  <div class="lib-entry-output"><strong>Output:</strong> FCA EP25/2-aligned proxy discrimination audit, disparate impact metrics, fairness-accuracy trade-off analysis, Consumer Duty evidence pack</div>
</div>
