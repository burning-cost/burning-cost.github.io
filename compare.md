...
| **Model monitoring** | [`insurance-monitoring`](https://github.com/burning-cost/insurance-monitoring) — exposure-weighted PSI/CSI, A/E ratios, Gini drift z-tests with scheduled alerts. v0.5.0 adds `SequentialTest` for anytime-valid A/B testing of champion/challenger experiments (mSPRT; peeking t-test has 25% FPR vs mSPRT at 1%) | Monitoring dashboards are common in enterprise platforms; insurance-specific metrics vary |
