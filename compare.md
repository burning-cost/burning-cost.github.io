...
| **Demand and price elasticity** | [`insurance-optimise`](https://github.com/burning-cost/insurance-optimise) — includes demand modelling for conversion and retention (via `insurance_optimise.demand`); [`insurance-causal`](https://github.com/burning-cost/insurance-causal) — includes causal DML elasticity estimation (via `insurance_causal.elasticity`) | Typically available as part of commercial optimisation modules; methodology often opaque |
...
| **Causal inference** | [`insurance-causal`](https://github.com/burning-cost/insurance-causal) — double machine learning for deconfounding and CausalForestDML price elasticity (includes elasticity submodule) | Not typically offered natively; DataRobot has some causal tooling |
