...
- **[insurance-evt](https://burning-cost.github.io/2026/03/25/insurance-evt/)**: marginal GPD/GEV, no covariate conditioning, full censored MLE and profile likelihood CI. Use it for portfolio-level threshold selection and return levels. EQRN extends this to segment level.
...
- **[insurance-evt](https://burning-cost.github.io/2026/03/25/insurance-evt/)** — Marginal GPD/GEV for portfolio-level EVT, with censored MLE for open TPBI claims and ExcessGPD layer pricing
