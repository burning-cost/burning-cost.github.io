...
The libraries referenced in this post — [`insurance-survival`](/insurance-survival/), [`insurance-causal`](/insurance-causal/), [`insurance-optimise`](/insurance-optimise/) — are pip-installable and designed to be used together. The workflow is not trivial, but neither is the problem it solves.
