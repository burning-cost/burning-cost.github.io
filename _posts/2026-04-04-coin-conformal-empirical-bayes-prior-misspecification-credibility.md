...
- [Credibility Theory in Python: A Complete Bühlmann-Straub Tutorial](/2026/04/04/credibility-theory-python-buhlmann-straub-tutorial/) — practical implementation of the B-S and Poisson-Gamma models, including the structural parameter diagnostics that reveal the instability this paper formalises
