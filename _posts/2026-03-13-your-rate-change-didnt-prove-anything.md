...
The FCA's anticipated evaluation of GIPP remedies (referenced in supervisory communications as EP25/2) used conditional DiD - building a control group of comparable firms that did not implement the remedied practices and comparing outcomes over the policy year following implementation. The methodology explicitly discusses parallel trends testing and counterfactual validity. The FCA is applying a higher standard to its own evaluations than it is seeing from regulated firms.
