...
- [Causal Fixed Effects for Rate Change Evaluation](/insurance-causal/) - panel fixed effects as a complementary identification strategy for rate changes with multi-year policy histories
