...
- [Tracking Trend Between Model Updates with GAS Filters](/2026/03/08/gas-models-for-between-update-trend/) - score-driven models for between-refit monitoring of the same underlying trend problem
- [Covariate Shift in Motor Pricing: Detection, Correction, and Conformal Intervals](/2026/03/02/your-book-has-shifted-and-your-model-doesnt-know/) - covariate shift detection as a precursor to recalibration
...
- [Conformal Guarantees for Reserve Ranges](/2026/03/16/reserve-range-conformal-guarantee/) — applying conformal guarantees to reserve ranges; uses the time-series methods described here for development pattern uncertainty
