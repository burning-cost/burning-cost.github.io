...
- [Detection vs Mitigation: insurance-fairness and EquiPy Are Not Competing](/2026/04/04/insurance-fairness-equipy-comparison/) — the EquiPy tail correction that implements exactly the kind of post-processing this paper calls for — Charpentier et al. tier-boundary parity, `insurance-fairness` v0.8.0
