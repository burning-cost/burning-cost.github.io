...
**Ethnicity (emerging).** FCA EP25/2 (2025) analysed six million motor policies covering more than 50% of the UK market. After full risk adjustment, there is a £28 per year unexplained residual in Luton — 43% minority ethnic population, mean premium £627. The FCA's current position is that this residual is likely unmeasured risk variables rather than direct discrimination. But pricing teams are on notice. If the residual persists through future review cycles, the regulatory pressure toward ethnicity data restrictions analogous to the gender ban will intensify.
