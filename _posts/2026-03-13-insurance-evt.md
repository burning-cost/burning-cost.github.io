...
**Package update:** `insurance-evt` has been consolidated into [`insurance-severity`](/insurance-distributional/). Install with `pip install insurance-severity` — extreme value theory for large loss pricing is available as a submodule. [View on GitHub →](https://github.com/burning-cost/insurance-severity)
</div>
...
- [EQRN: Covariate-Dependent Extreme Value Modelling for XL Pricing and Tail Reserving](/2026/03/12/insurance-eqrn/)
