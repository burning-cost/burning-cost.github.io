...
The UK position post-Brexit is equivalent. Article 272(2) of the retained Solvency II Directive (now embedded in UK law via SI 2019/1212) preserves the actuarial exception. The PRA's Actuarial Policy Conditions (SS1/23) require the Chief Actuary to sign off on pricing assumptions. Signing off on a model that deliberately ignores age for a product where mortality or morbidity is the primary driver would require extraordinary justification.
