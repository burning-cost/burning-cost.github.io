...
The [`insurance-trend`](/insurance-trend/) library handles this decomposition. You provide your historical claims series and the external index, and it fits a severity trend on the deflated series, reporting the index-measured component and the residual superimposed component separately.
