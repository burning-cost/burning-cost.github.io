...
- **Segmented, not aggregate**: a model can pass aggregate calibration while systematically mispricing a protected sub-group. Per the FCA's EP25/2 from July 2025, the concern is specifically proxy discrimination — where a rating factor that does not name a protected characteristic is nonetheless correlated with one.
