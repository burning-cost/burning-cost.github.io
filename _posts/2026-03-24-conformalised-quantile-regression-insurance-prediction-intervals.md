...
- [Per-Risk Volatility Scoring with Distributional GBMs](/2026/12/14/per-risk-volatility-scoring-with-distributional-gbms/) -- related approach to heteroscedastic modelling
- [Large Loss Loading for Home Insurance](/2026/10/14/large-loss-loading-for-home-insurance/) -- practical context for the reinsurance and large loss use cases above
