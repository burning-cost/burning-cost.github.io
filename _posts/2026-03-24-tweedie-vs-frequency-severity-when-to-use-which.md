...
For the dependence testing and Sarmanov correction, see [`insurance-frequency-severity`](/insurance-frequency-severity/). The `DependenceTest` class should be standard practice before finalising any pure premium modelling approach on a UK motor book.
