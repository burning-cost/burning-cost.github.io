...
**Related posts:**
- [Double GLM for Insurance Severity: Per-Policy Dispersion via the Smyth-Jørgensen Method](/2026/03/10/your-severity-model-assumes-the-wrong-variance/) - double GLM for modelling dispersion when the variance structure matters as much as the mean
