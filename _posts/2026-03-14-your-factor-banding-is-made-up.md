...
- [Your Rating Table Smoothing Is Wrong](/2026/03/18/your-rating-table-smoothing-is-wrong/) - the complement to optimal banding: once you have the right bins, WH smoothing with REML lambda selection graduates the curve so adjacent bands do not flip sign due to sampling noise
