...
date: 2028-08-15
author: Burning Cost
description: "Static credibility weights all years equally. The dynamic Poisson-gamma state-space model from Ahn et al. (2023) fixes this: recent experience counts more, and the model produces a full posterior, not just a point estimate."
