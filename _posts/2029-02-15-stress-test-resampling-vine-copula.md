...
`insurance-synthetic` is open source under MIT at [github.com/burning-cost/insurance-synthetic](https://github.com/burning-cost/insurance-synthetic). Requires Python 3.10+. Install with `pip install insurance-synthetic`. The vine family audit is in `InsuranceSynthesizer.summary()`.
