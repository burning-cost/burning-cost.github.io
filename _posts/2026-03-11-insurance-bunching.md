...
- [500 Vehicle Makes, One Afternoon, Zero Reproducibility](/2026/03/22/insurance-glm-cluster/) — `insurance-glm-tools` for factor level banding: the complement to threshold analysis when the problem is too many levels rather than gaming at the boundaries between them.
