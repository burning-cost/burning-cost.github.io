...
- [PRA SS1/23-Compliant Model Validation in Python](/2026/03/11/model-validation-pra-ss123/) — building a defensible sign-off process alongside the technical output
- [Double GLM for Insurance Severity: Per-Policy Dispersion via the Smyth-Jørgensen Method](/2026/03/10/your-severity-model-assumes-the-wrong-variance/) — why the Tweedie variance function matters and when to use a Gamma or inverse Gaussian instead
