...
**Accumulation monitoring over independent pricing.** A cyber book needs the same aggregate exposure management that catastrophe-exposed property lines get. Sub-limits, PML monitoring by attack vector, and explicit aggregate stop-loss structures should be on the table. Underwriters who think of cyber as a series of individual firm decisions are missing the portfolio dimension.
