...
The right tool is one built for the specific regulatory question: do your non-protected rating factors proxy for protected characteristics? That is what [`insurance-fairness`](/insurance-fairness/) is for.
