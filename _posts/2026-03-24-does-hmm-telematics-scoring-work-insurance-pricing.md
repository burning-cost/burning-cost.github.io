...
The library is at [github.com/burning-cost/insurance-telematics](https://github.com/burning-cost/insurance-telematics). The full validation notebook is at `notebooks/databricks_validation.py`, runnable on Databricks serverless.
