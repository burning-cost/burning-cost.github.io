...
The UK pricing team's standard toolkit has been largely unchanged for two decades. This pipeline connects tools like [insurance-governance](/insurance-governance/), [insurance-monitoring](/insurance-monitoring/), [insurance-fairness](/insurance-fairness/), and [insurance-causal](/insurance-causal/) into a coherent workflow.: Emblem or Radar for GLMs, Excel for scenario management, SAS or bespoke R scripts for data manipulation, and periodic exports to whatever catastrophe model the reinsurer mandates. It works. But it has structural limits that become more painful as model complexity increases.
