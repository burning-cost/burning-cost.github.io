...
- [Debiasing Price Elasticity Estimates with Double Machine Learning](/2026/03/15/causal-price-elasticity-tutorial/) — the tutorial that demonstrates the full workflow at realistic sample sizes using the methods developed here
