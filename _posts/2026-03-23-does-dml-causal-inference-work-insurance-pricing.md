...
So we ran the benchmark. Known data-generating process, synthetic UK motor book, multiplicative nonlinear confounding. We compared a naive logistic GLM  -  the standard approach  -  against DML via [`insurance-causal`](/2026/03/12/insurance-autodml/), and measured bias against the known ground truth. Here is what we found.
