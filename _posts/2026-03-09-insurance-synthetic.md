...
**No actuarial fidelity metrics.** SDV's built-in quality report computes column-wise KS statistics and pairwise correlation metrics. These are fine as far as they go. They tell you nothing about whether your synthetic data preserves TVaR at the 99th percentile, whether a GLM trained on synthetic produces the same rating factor relativities as one trained on real data, or whether the frequency/severity relationship survives synthesis. The [double machine learning benchmarks post](/2026/03/09/dml-insurance-benchmarks/) shows what happens when you use this library to generate data with a known ground-truth causal structure and test whether your estimator recovers it. These are the questions pricing actuaries actually care about.
...
- [Solvency II / PRA SS3/18-Compliant Model Validation in Python](/2026/03/14/insurance-governance-unified-pra-ss123-validation/)
