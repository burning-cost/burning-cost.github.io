...
The [insurance-fairness](https://github.com/burning-cost/insurance-fairness) library provides the tooling for this analysis. Run it on your text features before you run it on production data. The documentation has an example for continuous features that applies directly to PCA-reduced embeddings.
