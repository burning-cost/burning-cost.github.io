...
`[insurance-monitoring](/2026/03/21/insurance-model-monitoring-beyond-generic-drift/)` exposes an `exposure_weights` parameter directly on the PSI and CSI functions:
...
**Related:**
- [Alibi Detect vs insurance-monitoring: Drift Detection for Insurance Pricing Models](/2026/03/18/alibi-detect-vs-insurance-monitoring-drift-detection/) - the same comparison against Alibi Detect
