...
The library is at [github.com/burning-cost/insurance-conformal](https://github.com/burning-cost/insurance-conformal). The full benchmark is in `benchmarks/benchmark_gbm.py`, runnable on Databricks serverless in under five minutes.
