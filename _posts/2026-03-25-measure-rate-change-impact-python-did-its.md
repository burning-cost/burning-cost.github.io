...
- [Your Rate Change Didn't Prove Anything](/2026/03/13/your-rate-change-didnt-prove-anything/) — the conceptual argument for why before/after comparisons fail under FCA Consumer Duty outcome monitoring requirements, and how `insurance-causal-policy` handles the harder SDID case with staggered adoption
