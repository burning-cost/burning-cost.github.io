...
The library is at [github.com/burning-cost/insurance-frequency-severity](https://github.com/burning-cost/insurance-frequency-severity). The benchmark is in `benchmarks/benchmark_insurance_frequency_severity.py`, runnable on Databricks serverless. The pure Sarmanov DGP benchmark takes roughly 10 minutes end-to-end (most of that is the per-policy acceptance-rejection sampling for 15,000 policies).
