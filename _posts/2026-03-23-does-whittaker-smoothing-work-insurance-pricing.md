...
The library is at [github.com/burning-cost/insurance-whittaker](https://github.com/burning-cost/insurance-whittaker). The benchmark used in this post is in `databricks/benchmark_whittaker_vs_baselines.py`.
