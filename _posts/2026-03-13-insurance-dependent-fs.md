---
layout: post
title: "Frequency-Severity Dependence in UK Motor: A Shared-Trunk Neural Architecture"
date: 2026-03-13
author: Burning Cost
...
The parameter γ has a clean interpretation: a one-unit increase in realised claims multiplies expected severity by e^γ. For UK motor, γ is negative. The NeurFS paper (arXiv:2106.10770, subsequently withdrawn by the author in March 2025) extended this to neural networks by training two separate networks - one for frequency, one for severity - with N fed into the severity head. Peng Shi and Kun Shi (Variance, 17(1), 2024) added sparse group lasso regularisation on top of the same architecture.
