...
*causalfe is available via `uv add causalfe`. The underlying paper is Aytug (2026), arXiv:2601.10555. For aggregate causal rate change evaluation, see our [insurance-causal-policy](https://github.com/burning-cost/insurance-causal-policy) library (SDID + CS21). Burning Cost has no affiliation with the causalfe authors.*
